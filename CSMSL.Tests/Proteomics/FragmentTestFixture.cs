...
namespace CSMSL.Tests.Proteomics
{
    ...
    public sealed class FragmentTestFixture
    {
        ...
        {
            Fragment fragment = MockPeptideEveryAminoAcid.Fragment(FragmentTypes.b, 0);            
        }
        ...
        {
            Fragment fragment = MockPeptideEveryAminoAcid.Fragment(FragmentTypes.b, 25);            
        }
        ...
        {
            List<Fragment> fragments = MockPeptideEveryAminoAcid.Fragment(FragmentTypes.b).ToList();
