...
namespace CSMSL.Tests.Analysis.Quantitation
{
    ...
    public sealed class QuantifiedPeptideTestFixture
    {
        ...
        public void SetUp()
        {
            ...
            QuantPeakTMT1 = new QuantifiedPeak(126.0, 1, 10.0, 1.0);
            QuantPeakTMT2 = new QuantifiedPeak(127.0, 1, 5.0, 1.0);
            QuantPeakTMT3 = new QuantifiedPeak(128.0, 1, 10.0, 1.0);
            QuantPeakTMT4 = new QuantifiedPeak(129.0, 1, 5.0, 1.0);
            QuantPeakTMT5 = new QuantifiedPeak(130.0, 1, 0.0, 1.0);
            QuantPeakTMT6 = new QuantifiedPeak(131.0, 1, 5.0, 1.0);
            QuantPeakTMT7 = new QuantifiedPeak(126.1, 1, 25.2, 1.5);
            QuantPeakTMT8 = new QuantifiedPeak(127.1, 1, 11.3, 1.5);
            QuantPeakTMT9 = new QuantifiedPeak(128.1, 1, 18.9, 1.5);
            QuantPeakTMT10 = new QuantifiedPeak(129.1, 1, 2.5, 1.5);
            QuantPeakTMT11 = new QuantifiedPeak(130.1, 1, 1.2, 1.5);
            QuantPeakTMT12 = new QuantifiedPeak(131.1, 1, 10.0, 1.5);
            QuantPeakTMT13 = new QuantifiedPeak(126.2, 1, 62.8, 2.0);
            QuantPeakTMT14 = new QuantifiedPeak(127.2, 1, 38.3, 2.0);
            QuantPeakTMT15 = new QuantifiedPeak(128.2, 1, 75.2, 2.0);
            QuantPeakTMT16 = new QuantifiedPeak(129.2, 1, 9.1, 2.0);
            ...
            QuantPeakNeuCode3 = new QuantifiedPeak(443.424, 3, 100.0, 10.0);
            QuantPeakNeuCode4 = new QuantifiedPeak(443.433, 3, 50.0, 10.0);
            QuantPeakNeuCode5 = new QuantifiedPeak(443.757, 3, 0.0, 10.0);
            QuantPeakNeuCode6 = new QuantifiedPeak(443.770, 3, 50.0, 10.0);
            QuantPeakNeuCode7 = new QuantifiedPeak(664.137, 2, 250.2, 10.5);
            QuantPeakNeuCode8 = new QuantifiedPeak(664.153, 2, 110.3, 10.5);
            QuantPeakNeuCode9 = new QuantifiedPeak(664.640, 2, 180.9, 10.5);
            QuantPeakNeuCode10 = new QuantifiedPeak(664.655, 2, 20.5, 10.5);
            QuantPeakNeuCode11 = new QuantifiedPeak(665.137, 2, 10.2, 10.5);
            QuantPeakNeuCode12 = new QuantifiedPeak(665.160, 2, 100.0, 10.5);
            QuantPeakNeuCode13 = new QuantifiedPeak(443.089, 3, 620.8, 20.0);
            QuantPeakNeuCode14 = new QuantifiedPeak(443.100, 3, 380.3, 20.0);
            QuantPeakNeuCode15 = new QuantifiedPeak(443.421, 3, 750.2, 20.0);
            QuantPeakNeuCode16 = new QuantifiedPeak(443.435, 3, 90.1, 20.0);
